...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-footer" align="right">
            ...
            <button class="btn btn-danger" onclick="abortFilter()"><span class="fa fa-close"></span><spring:message
                    code="meal.reset"/></button>
            <button class="btn btn-primary" onclick="updateTableWithFilter()"><span class="fa fa-filter"></span><spring:message
